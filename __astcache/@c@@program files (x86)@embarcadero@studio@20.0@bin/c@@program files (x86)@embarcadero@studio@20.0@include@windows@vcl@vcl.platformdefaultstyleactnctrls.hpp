...
// (DO NOT EDIT: machine generated header) 'Vcl.PlatformDefaultStyleActnCtrls.pas' rev: 33.00 (Windows)
...
public:
	...
	virtual Vcl::Actnctrls::TCustomToolScrollBtnClass __fastcall GetScrollBtnClass();
public:
