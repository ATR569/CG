...
// (DO NOT EDIT: machine generated header) 'Vcl.ActnMenus.pas' rev: 33.00 (Windows)
...
public:
	...
	virtual Vcl::Actnctrls::TCustomToolScrollBtnClass __fastcall GetScrollBtnClass() = 0 ;
public:
...
public:
	/* TSpeedButton.Create */ inline __fastcall virtual TCustomMDIMenuButton(System::Classes::TComponent* AOwner) : Vcl::Buttons::TSpeedButton(AOwner) { }
	/* TSpeedButton.Destroy */ inline __fastcall virtual ~TCustomMDIMenuButton() { }
